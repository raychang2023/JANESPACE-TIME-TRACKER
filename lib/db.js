...
function migrate(database) {
  ...
  addColumn(database, "time_records", "clockInWarehouseId", "TEXT");
  addColumn(database, "time_records", "clockInWarehouseName", "TEXT");
  ...
  addColumn(database, "time_records", "clockOutWarehouseId", "TEXT");
  addColumn(database, "time_records", "clockOutWarehouseName", "TEXT");
}
